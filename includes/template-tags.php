...
================================================================================================
*/
function fervent_entry_posted_on_setup() {
    $author_avatar_size = apply_filters('fervent_author_avatar_size', 80);
    ...
    esc_attr(sprintf(__('View all posts by %s', 'fervent'), get_the_author())), 
    get_the_author()
    ));
    if ( !is_page() && !post_password_required() && (comments_open() || get_comments_number())) {
        echo '<span class="entry-comments"><b>';
            comments_popup_link( sprintf( __( 'Leave a Comment', 'fervent')));
        echo '</b></span>';
    }
}
/*
...
================================================================================================
*/
function fervent_entry_time_stamp_setup() {
	...
	return sprintf(
		__('<span class="screen-reader-text">Posted on</span> %s', 'fervent'),
...
================================================================================================
*/
function fervent_entry_taxonomies_setup() {
